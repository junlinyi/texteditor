...
/**
 * Main driver class that runs the applications of the text editor.
...
public class Editor extends Application {
   ...
   /**
    * Starts the text editor application based on user-defined arguments args.
    * @param args
    */
   ...
   /**
    * Starts the text editor and initializes settings.
    */
   @Override
   ...
   /**
    * Sets up the dictionary from which words are pulled from and loads it into 
    * the text editor.
    */
   ...
   /**
    * Sets up the spell checker and loads it into the text editor.
    */
   ...
   /**
    * Sets up the "clear-formatter" tool in the text editor.
    * @param htmlEditor
    */
   ...
   /**
    * Sets up auto-complete functionality and loads it into the text editor.
    */
   ...
   /**
    * Sets up search functionality and loads it into the text editor.
\    */
   ...
   /**
    * Retrieves a top tool-bar to be used in the text editor.
    */
